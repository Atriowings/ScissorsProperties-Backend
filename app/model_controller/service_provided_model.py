...
class ServiceProvide:
    ...
    def push_coupon_to_service(self, service_id, coupon_data):
        if not isinstance(coupon_data, dict) or not coupon_data.get("couponCode"):
            print("Invalid coupon data:", coupon_data)
            return
