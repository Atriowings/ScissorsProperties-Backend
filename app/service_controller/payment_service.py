...
class PaymentService:
    ...
    def complete_payment_flow(self, user_id, plan_type, upi, upi_mobile_number):
        ...
        if user.get("referredBy") == "collaborator" and plan_type != "C":
            return None, "Collaborator referrals are only allowed to choose Plan C"
        ...
        if is_first_payment:
            self.payment_model.create_payment(user_id, total_amount, upi,upi_mobile_number,plan_type)
