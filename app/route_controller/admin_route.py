...
from app.admin_controller.admin import (
    ...
    get_partner_overview,get_agent_overview,get_dealer_overview,handle_user_request, mark_full_payment, 
    give_monthly_commission, list_partners,list_agents,list_dealers,
...
admin_bp.route("/agents", methods=["GET"])(list_agents)
admin_bp.route('/agent-overview', methods=['GET'])(get_agent_overview)
admin_bp.route("/dealers", methods=["GET"])(list_dealers)
admin_bp.route('/dealer-overview', methods=['GET'])(get_dealer_overview)
...
admin_bp.route('/approve-plot-payment', methods=['POST'])(admin_approve_plot_payment)
admin_bp.route('/decline-plot', methods=['POST'])(admin_decline_plot)
