...
auth_bp.route('/api/health', methods=['GET'])(health_check)
auth_bp.route('/api/test-cors', methods=['GET', 'POST', 'OPTIONS'])(cors_test)

auth_bp.route('/api/register', methods=['POST', 'OPTIONS'])(Signup)
